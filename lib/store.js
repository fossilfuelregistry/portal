...
const reducer = ( state = initialState, action ) => {
	...
	// Only hydrate once in browser.
	if( typeof window !== 'undefined' && hydrated && action.type === HYDRATE ) {
		console.log( '>!< Skipping HYDRATE' )
		return state
	}
	...
	switch( action.type ) {
		case HYDRATE:
			...
			return {
				...
				project: null, // Project needs to be set once data loaded.
