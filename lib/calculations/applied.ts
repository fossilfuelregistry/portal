...
import { CoalCO2EProductionEmission, isoCoalCO2EProductionEmission } from "./coal";
import { GasCO2ECombustionEmissions, GasCO2EProductionEmissions, isoGasCO2ECombustionEmissions, isoGasCO2EProductionEmissions } from "./gas";
import { isoOilCO2ECombustionEmissions, isoOilCO2EProductionEmissions, OilCO2ECombustionEmissions, OilCO2EProductionEmissions } from "./oil";
...
export const calculateScope3 = ({oil, gas, coal}: CalculateScope3Params):
 Scenarios => 
     pipe(
        add,
