...
export interface GasProduction
  extends Newtype<{ readonly GasProduction: unique symbol }, number> {}
...
export interface PetajoulesPerMillionCubicMeterGas
  extends Newtype<
...
export interface GasEnergy
  extends Newtype<{ readonly GasEnergy: unique symbol }, number> {}
...
export interface EIAGasNFURatioGlobally
  extends Newtype<{ readonly EIAGasNFURatioGlobally: unique symbol }, number> {}
export const isoEIAGasNFURatioGlobally = iso<EIAGasNFURatioGlobally>();

/**  Gas: IPCC energy -> emissions  [ tons (CO2E) / TJ ] */
export interface GasIPCCEnergyToEmissionsFactors
  extends Newtype<
...
export interface GasCO2ECombustionEmissions
  extends Newtype<
...
export interface BOEPere6m3
  extends Newtype<{ readonly BOEPere6m3: unique symbol }, number> {}
export const isoBOEPere6m3 = iso<BOEPere6m3>();

/**  Barrels of oil equivalent [ boe ] */
export interface BarrelsOfOilEquivalent
  extends Newtype<{ readonly BarrelsOfOilEquivalent: unique symbol }, number> {}
...
export interface GasProductionCO2
  extends Newtype<{ readonly GasProductionCO2: unique symbol }, Scenarios> {}
export const isoGasProductionCO2 = iso<GasProductionCO2>();

/**  Gas CO2 Production emissions [ tons (CO2E) ] */
export interface GasCO2ProductionEmissions
  extends Newtype<
...
export const calculateGasCO2ProductionEmissions =
  ...
  (gasProductionCO2: GasProductionCO2): GasCO2ProductionEmissions => {
    ...
    return isoGasCO2ProductionEmissions.wrap(
      scalarMultiply(_barrelsOfOilEquivalent / THOUSANDS_IN_A_MILLION_RATIO)(
        _gasProductionCO2
      )
    );
  };
...
export interface GasMethaneReleases
  extends Newtype<{ readonly MethaneReleases: unique symbol }, number> {}
...
export interface GasCO2EOfMethane
  extends Newtype<{ readonly GasCO2EOfMethane: unique symbol }, number> {}
...
export interface GasCO2EProductionEmissions
  extends Newtype<
...
export interface TotalGasCO2EEmissions
  extends Newtype<
